 ...
 * @author bukhari
 */
public class TranformationForm extends javax.swing.JInternalFrame {

    /**
     * Creates new form TranformationForm
     */
    public TranformationForm() {
        initComponents();
        ...
        timer.stop();
        Lbl_Msg.setText("Transformation Complete Sucessfully");
    ...
    private void initComponents() {
        ...
        setTitle("Tranformation");

        ProgressBar1.setMinimum(1);

        Lbl_Msg.setText("Tranformation in Progress.....");
    ...
    private void BTN_OKActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BTN_OKActionPerformed
       // FRMOWLDisplay frm = new FRMOWLDisplay();
        System.out.println(this.getParent().getComponent(1).toString());
...
// TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TranformationForm().setVisible(true);
            }
        });
    }
